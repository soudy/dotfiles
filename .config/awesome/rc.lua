--[[
     ...
     Komorebi Awesome WM config 2.0
...
iptraf     = terminal .. " -g 150x54-20+34 -e sudo iptraf-ng -i all "
musicplr   = terminal .. " -g 120x34-160+16 -e ncmpcpp "
...
-- {{{ Tags
tags = {
   names = { "www", "term", "chat", "files", "other" },
   layout = { layouts[1], layouts[2], layouts[2], layouts[3], layouts[3] }
}
...
fswidgetbg = wibox.widget.background(fswidget, "#2e3233")
...
netwidget = wibox.widget.background(lain.widgets.net({
    settings = function()
        widget:set_markup(markup("#B0777B", " " .. net_now.received)
                          .. " " ..
                          markup("#8B99B5", " " .. net_now.sent .. " "))
    end
}), "#2e3233")
...
globalkeys = awful.util.table.join(
    ...
    --awful.key({ modkey }, "s", function ()
        --mywibox[widget.systray()].visible = not mywibox[widget.systray()].visible
